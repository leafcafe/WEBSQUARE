/*amd /page/P00237.xml 8587 d17c5546a2c4cade958cf3cd76db31172ced03d38845faad922762167fca1582 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'sub_contents'},E:[{T:1,N:'xf:group',A:{class:'ws_example_grp_desc'},E:[{T:1,N:'w2:textbox',A:{class:'',escape:'false',label:'GridView의 엑셀 다운로드(함수 \'advancedExcelDownload\') 옵션 중 푸터의 스타일을 적용할 수 있는 옵션 설정의 예제입니다.<br/>푸터 스타일을 지정할 수 있는 옵션은 아래와 같습니다.<br/>- footerColor : <String:N> [default: #008000] Excel 파일에서 그리드의 footer분의 색<br/>- footerFontName : <String:N> [default: 없음] Excel 파일에서 그리드의 footer의 font name<br/>- footerFontSize : <String:N> Excel 파일에서 그리드의 footer의 font size<br/>- footerFontColor : <String:N> [default: 없음] Excel 파일에서 그리드의 footer의 font 색<br/>- footerFontBold : <String:N> [default: 없음] Excel 파일에서 그리드의 footer의 Bold 적용 유무',style:''}},{T:1,N:'w2:textbox',A:{class:'txt_info_important',escape:'false',label:'이 기능은 옵션 \'useStyle\'을 \'false\'로 지정해야 동작합니다.',style:''}},{T:1,N:'w2:textbox',A:{class:'',escape:'false',label:'다운로드된 엑셀 파일의 푸터 영역의 스타일을 비교합니다.',style:''}}]},{T:1,N:'xf:group',A:{class:'example_div_tb_style_wrap'},E:[{T:1,N:'xf:group',A:{class:'mb_def_box nobottom'},E:[{T:1,N:'xf:trigger',A:{class:'btn_exam_exec btn_txt_of','ev:onclick':'scwin.btn_ex1_onclick',id:'btn_ex1',localeRef:'',style:'min-width: 30px; height: 26px;',type:'',useDefaultLabel:'true'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'엑셀 다운로드 - 기본'}]}]},{T:1,N:'xf:trigger',A:{class:'btn_exam_exec btn_txt_of','ev:onclick':'scwin.btn_ex2_onclick',id:'btn_ex2',localeRef:'',style:'min-width:30px;height:26px;',type:'',useDefaultLabel:'true'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'엑셀 다운로드 - 푸터의 스타일 적용'}]}]}]},{T:1,N:'w2:gridView',A:{autoFitMinWidth:'266',baseNode:'',class:'wq_gvw',dataList:'data:dlt_books',defaultCellHeight:'26',focusMode:'row',id:'grd_exam1',readOnly:'true',style:'height:150px;',visibleRowNum:'all',autoFit:'allColumn'},E:[{T:1,N:'w2:header',A:{id:'header5',style:''},E:[{T:1,N:'w2:row',A:{id:'row35',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',hidden:'false',id:'column572',inputType:'text',value:'분류',width:'68'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'column575',inputType:'text',value:'도서명',width:'90'}},{T:1,N:'w2:column',A:{id:'column468',inputType:'text',value:'상반기',width:'54'}},{T:1,N:'w2:column',A:{id:'column467',inputType:'text',value:'하반기',width:'54'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody5',style:''},E:[{T:1,N:'w2:row',A:{id:'row37',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',colMerge:'true',displayMode:'label',hidden:'false',id:'category1',inputType:'text',width:'68'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'title',inputType:'text',textAlign:'left',width:'90'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',id:'row3_1',inputType:'text',textAlign:'right',width:'54'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',id:'row3_2',inputType:'text',textAlign:'right',width:'54'}}]}]},{T:1,N:'w2:footer',A:{id:'footer1',style:''},E:[{T:1,N:'w2:row',A:{id:'row41',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'column580',inputType:'text',style:'height:40px;',value:'합계',width:'68'}},{T:1,N:'w2:column',A:{expression:'count(\'row_total\') +\'건\'',id:'column597',inputType:'expression',style:'height:40px;',textAlign:'left',width:'90'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',expression:'sum(\'row3_1\')',id:'column526',inputType:'expression',style:'height:40px;',textAlign:'right',width:'54'}},{T:1,N:'w2:column',A:{blockSelect:'false',dataType:'number',displayFormat:'#,###',displayMode:'label',expression:'sum(\'row3_2\')',id:'column584',inputType:'expression',style:'height:40px;',textAlign:'right',width:'54'}}]}]}]}]}]}]}]}]})