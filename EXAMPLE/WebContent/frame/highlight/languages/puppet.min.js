				...
				name: "Puppet", aliases: ["pp"], contains: [s, n, i, {
					...
					beginKeywords: "define", end: /\{/,
						...
						begin: e.IDENT_RE + "\\s+\\{", returnBegin: !0, end: /\S/, contains: [{
							...
							}, relevance: 0, contains: [i, s, {
								begin: "[a-zA-Z_]+\\s*=>", returnBegin: !0, end: "=>",
