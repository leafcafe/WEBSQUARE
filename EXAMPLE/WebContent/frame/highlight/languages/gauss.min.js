		...
		"use strict"; return e => {
			const t = {
				...
				className: "meta", begin: "#", end: "$", keywords: {
					...
					keywords: { keyword: "include" }, contains: [{
						className: "string", begin: '"', end: '"',
						illegal: "\\n"
					}]
				}, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a]
			}, n = {
				begin: /\bstruct\s+/, end: /\s/, keywords: "struct", contains: [{
					className: "type",
				...
				const d = e.inherit({
					className: "function", beginKeywords: t, end: r, excludeEnd: !0,
					contains: [].concat(s)
				}, n || {})
					; return d.contains.push(o), d.contains.push(e.C_NUMBER_MODE),
						d.contains.push(e.C_BLOCK_COMMENT_MODE), d.contains.push(a), d
			}, l = {
				className: "built_in", begin: "\\b(" + t.built_in.split(" ").join("|") + ")\\b"
			}, i = {
				className: "string", begin: '"', end: '"', contains: [e.BACKSLASH_ESCAPE], relevance: 0
			}, c = {
				begin: e.UNDERSCORE_IDENT_RE + "\\s*\\(", returnBegin: !0, keywords: t,
				relevance: 0, contains: [{ beginKeywords: t.keyword }, l, {
					className: "built_in",
					begin: e.UNDERSCORE_IDENT_RE, relevance: 0
				}]
			}, p = {
			...
			; return c.contains.push(p), {
				name: "GAUSS", aliases: ["gss"], case_insensitive: !0,
				keywords: t, illegal: /(\{[%#]|[%#]\}| <- )/,
				contains: [e.C_NUMBER_MODE, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, i, r, {
					className: "keyword",
					begin: /\bexternal (matrix|string|array|sparse matrix|struct|proc|keyword|fn)/
				}, d("proc keyword", ";"), d("fn", "="), {
					beginKeywords: "for threadfor", end: /;/,
					relevance: 0, contains: [e.C_BLOCK_COMMENT_MODE, a, p]
				}, {
					variants: [{
