	...
	var e = (() => {
		"use strict"; return e => {
			const a = e.regex, s = /[a-zA-Z]\w*/, t = ["as", "break", "class", "construct", "continue", "else", "for", "foreign", "if", "import", "in", "is", "return", "static", "var", "while"], c = ["true", "false", "null"], n = ["this", "super"], r = ["-", "~", /\*/, "%", /\.\.\./, /\.\./, /\+/, "<<", ">>", ">=", "<=", "<", ">", /\^/, /!=/, /!/, /\bis\b/, "==", "&&", "&", /\|\|/, /\|/, /\?:/, "="], i = {
				...
				className: "title.function", starts: {
					contains: [{
						begin: /\(/, end: /\)/, contains: [{
							relevance: 0, scope: "params", match: s
						}]
					}]
				}
			}, l = {
				...
				relevance: 0,
				match: a.either(...r), className: "operator"
			}, b = {
				className: "property",
				begin: a.concat(/\./, a.lookahead(s)), end: s, excludeBegin: !0, relevance: 0
			}, h = {
				relevance: 0, match: a.concat(/\b_/, s), scope: "variable"
			}, p = {
				relevance: 0,
				...
				match: [s, /\s*/, /=/, /\s*/, /\(/, s, /\)\s*\{/], scope: {
					1: "title.function", 3: "operator", 6: "params"
				}
			}, d = e.COMMENT(/\/\*\*/, /\*\//, {
				contains: [{ match: /@[a-z]+/, scope: "doctag" }, "self"]
			}), v = {
				scope: "subst",
				begin: /%\(/, end: /\)/, contains: [u, p, i, h, m]
			}, f = {
				scope: "string", begin: /"/, end: /"/,
				contains: [v, {
					scope: "char.escape", variants: [{ match: /\\\\|\\["0%abefnrtv]/ }, {
						match: /\\x[0-9A-F]{2}/
					}, { match: /\\u[0-9A-F]{4}/ }, { match: /\\U[0-9A-F]{8}/ }]
				}]
			}
				; v.contains.push(f); const N = [...t, ...n, ...c], _ = {
					relevance: 0,
					...
					name: "Wren", keywords: {
						keyword: t,
						"variable.language": n, literal: c
					}, contains: [{
						scope: "comment", variants: [{
