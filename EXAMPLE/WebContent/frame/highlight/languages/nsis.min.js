...
(() => {
	var e = (() => {
		"use strict"; return e => {
			const t = e.regex, n = {
			...
			}, i = { className: "variable", begin: /\$+\{[\!\w.:-]+\}/ }, r = {
				className: "variable",
				begin: /\$+\w[\w\.]*/, illegal: /\(\)\{\}/
			}, a = {
				className: "variable",
				...
				match: [/Function/, /\s+/, t.concat(/(\.)?/, e.IDENT_RE)], scope: {
					1: "keyword",
					3: "title.function"
				}
			}; return {
				name: "NSIS", case_insensitive: !0, keywords: {
					...
					match: [/Var/, /\s+/, /(?:\/GLOBAL\s+)?/, /[A-Za-z][\w.]*/], scope: {
						1: "keyword", 3: "params", 4: "variable"
					}
				}, S, {
