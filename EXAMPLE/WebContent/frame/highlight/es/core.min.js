...
const x = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", w = {
	...
	C_NUMBER_MODE: { scope: "number", begin: x, relevance: 0 }, BINARY_NUMBER_MODE: {
		scope: "number", begin: "\\b(0b[01]+)", relevance: 0
	}, REGEXP_MODE: {
		begin: /(?=\/[^/\n]*\/)/, contains: [{
			scope: "regexp", begin: /\//, end: /\/[gimuy]*/,
	...
	; function D(e, t, n = "keyword") {
		const i = Object.create(null)
		; return "string" == typeof e ? r(n, e.split(" ")) : Array.isArray(e) ? r(n, e) : Object.keys(e).forEach((n => {
			Object.assign(i, D(e[n], t, n))
		})), i; function r(e, n) {
		...
		return t ? Number(t) : (e => B.includes(e.toLowerCase()))(e) ? 0 : 1
	} const P = {}, C = e => {
		console.error(e)
	}, $ = (e, ...t) => { console.log("WARN: " + e, ...t) }, U = (e, t) => {
		P[`${e}/${t}`] || (console.log(`Deprecated as of ${e}. ${t}`), P[`${e}/${t}`] = !0)
	}, z = Error(); function K(e, t, { key: n }) {
			...
			if (Array.isArray(e.begin)) {
				if (e.skip || e.excludeBegin || e.returnBegin) throw C("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),
					...
					; if ("object" != typeof e.beginScope || null === e.beginScope) throw C("beginScope must be object"),
						z; K(e, e.begin, { key: "beginScope" }), e.begin = E(e.begin, { joinWith: "" })
			}
		})(e), (e => {
			if (Array.isArray(e.end)) {
				if (e.skip || e.excludeEnd || e.returnEnd) throw C("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
					...
					; if ("object" != typeof e.endScope || null === e.endScope) throw C("endScope must be object"),
						z; K(e, e.end, { key: "endScope" }), e.end = E(e.end, { joinWith: "" })
			}
		})(e)
	} function X(e) {
		function t(t, n) {
...
const F = r, V = s, q = Symbol("nomatch"); var J = (e => {
	const t = Object.create(null), r = Object.create(null), s = []; let o = !0
		; const a = "Could not find the language '{}', did you forget to load/include a language module?", c = {
			...
			const c = Object.create(null); function l() {
				if (!v.keywords) return void M.addText(S)
					...
					; for (; t;) {
						...
						; const r = y.case_insensitive ? t[0].toLowerCase() : t[0], s = (i = r, v.keywords[i]); if (s) {
							...
							; e = v.keywordPatternRe.lastIndex, t = v.keywordPatternRe.exec(S)
					} var i
				...
				return e.scope && "string" == typeof e.scope && M.openNode(y.classNameAliases[e.scope] || e.scope),
					e.beginScope && (e.beginScope._wrap ? (M.addKeyword(S, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
						S = "") : e.beginScope._multi && (u(e.beginScope, t), S = "")), v = Object.create(e, {
							parent: {
								value: v
							}
						}), v
				...
				return 0 === v.matcher.regexIndex ? (S += e[0], 1) : (I = !0, 0)
			} function b(e) {
			...
			let m = {}; function w(t, s) {
				...
				if (m = s, "begin" === s.type) return (e => {
					...
					; if ("illegal" === s.type && !r) {
						const e = Error('Illegal lexeme "' + a + '" for mode "' + (v.scope || "<unnamed>") + '"')
							; throw e.mode = v, e
					} if ("end" === s.type) { const e = b(s); if (e !== q) return e }
				...
				; if (!y) throw C(a.replace("{}", e)), Error('Unknown language: "' + e + '"')
					; const _ = X(y); let O = "", v = s || _; const N = {}, M = new g.__emitter(g); (() => {
						const e = []
						; for (let t = v; t !== y; t = t.parent)t.scope && e.unshift(t.scope)
							; e.forEach((e => M.openNode(e)))
					})(); let S = "", R = 0, A = 0, j = 0, I = !1; try {
						for (v.matcher.considerAll(); ;) {
							j++, I ? I = !1 : v.matcher.considerAll(), v.matcher.lastIndex = A
								...
								; A = e.index + t
						} return w(n.substr(A)), M.closeAllNodes(), M.finalize(), O = M.toHTML(), {
							language: e, value: O, relevance: R, illegal: !1, _emitter: M, _top: v
						}
					} catch (t) {
			...
			})(e), r = n.filter(k).filter(v).map((t => E(t, e, !1)))
	...
	"undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
		...
		autoDetection: v, inherit: V, addPlugin: e => {
			(e => {
