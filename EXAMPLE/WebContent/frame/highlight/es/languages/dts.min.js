	...
	"use strict"; return e => {
		const a = {
			...
			className: "meta", begin: "#", end: "$", keywords: {
				...
				beginKeywords: "include", end: "$", keywords: { keyword: "include" },
				contains: [e.inherit(a, { className: "string" }), {
			...
			name: "Device Tree", contains: [{
				...
				begin: /[a-zA-Z_][a-zA-Z\d_@-]*(?=\s\{)/, relevance: .2
			}, {
				relevance: 0,
			...
			}, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, n, a, s, {
				scope: "punctuation",
				relevance: 0, match: /\};|[;{}]/
