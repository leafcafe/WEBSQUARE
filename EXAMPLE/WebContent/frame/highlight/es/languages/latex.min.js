...
var hljsGrammar = (() => {
	"use strict"; return e => {
		const a = [{
			...
			begin: /#+\d?/
		}, { variants: a }, { className: "built_in", relevance: 0, begin: /[$&^_]/ }, {
			...
			contains: [i, ...n]
		}, s = { begin: /\s+/, relevance: 0 }, c = [t], l = [r], o = (e, a) => ({
		...
		}, o(c, n)), g = (a = "string") => e.END_SAME_AS_BEGIN({
			className: a, begin: /(.|\r?\n)/,
			...
			contains: [...["verb", "lstinline"].map((e => d(e, { contains: [g()] }))), d("mint", o(c, {
				contains: [g()]
			})), d("mintinline", o(c, { contains: [p(), g()] })), d("url", {
