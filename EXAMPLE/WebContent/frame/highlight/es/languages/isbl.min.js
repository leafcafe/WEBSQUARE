...
var hljsGrammar = (() => {
	"use strict"; return S => {
		const E = "[A-Za-z\u0410-\u042f\u0430-\u044f\u0451\u0401_!][A-Za-z\u0410-\u042f\u0430-\u044f\u0451\u0401_0-9]*", _ = {
			className: "number", begin: S.NUMBER_RE, relevance: 0
		}, T = {
			className: "string",
			...
			variants: [{
				...
				relevance: 0, contains: [S.PHRASAL_WORDS_MODE, R]
			}]
		}, C = {
			$pattern: E,
			...
			className: "variable", keywords: C, begin: E,
			relevance: 0, contains: [N, I]
		}, e = "[A-Za-z\u0410-\u042f\u0430-\u044f\u0451\u0401_][A-Za-z\u0410-\u042f\u0430-\u044f\u0451\u0401_0-9]*\\("
			; return {
				name: "ISBL", case_insensitive: !0, keywords: C,
				illegal: "\\$|\\?|%|,|;$|~|#|@|</", contains: [{
					className: "function", begin: e,
					...
					contains: [{
						...
						}, begin: e, end: "\\(", returnBegin: !0, excludeEnd: !0
					}, I, A, T, _, O]
				}, N, I, A, T, _, O]
			}
	}
