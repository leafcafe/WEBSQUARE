...
var hljsGrammar = (() => {
	"use strict"; return e => {
		const t = e.regex, a = /(?![A-Za-z0-9])(?![$])/, r = t.concat(/[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/, a), n = t.concat(/(\\?[A-Z][a-z0-9_\x7f-\xff]+|\\?[A-Z]+(?=[A-Z][a-z0-9_\x7f-\xff])){1,}/, a), o = {
			...
			scope: { 3: "title.function.invoke" }, contains: [I]
		}; I.contains.push(O)
			; const v = [f, h, e.C_BLOCK_COMMENT_MODE, l, d, g]; return {
				case_insensitive: !1,
				keywords: E, contains: [{
				...
				}, { scope: "variable.language", match: /\$this\b/ }, o, O, h, {
					...
					excludeEnd: !0, illegal: "[$%\\[]", contains: [{
						...
						contains: ["self", o, h, e.C_BLOCK_COMMENT_MODE, l, d]
					}]
				}, {
