...
var hljsGrammar = (() => {
	"use strict"; return e => {
		const a = "a-zA-Z_\\-!.?+*=<>&#'", t = "[" + a + "][" + a + "0-9/;:]*", i = {
			...
			className: "comment", begin: "\\^" + t
		}, m = e.COMMENT("\\^\\{", "\\}"), p = { className: "symbol", begin: "[:]{1,2}" + t }, u = {
			begin: "\\(", end: "\\)"
		}, f = { endsWithParent: !0, relevance: 0 }, h = {
			className: "name",
			relevance: 0, keywords: i, begin: t, starts: f
		}, g = [u, s, d, m, o, p, c, n, l, r]
